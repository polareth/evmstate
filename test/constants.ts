...
export const CONTRACTS = {
  ...
  DelegateBase: contracts.DelegateBase.withAddress(`0x${"5".repeat(40)}`),
  DelegateLogic: contracts.DelegateLogic.withAddress(`0x${"6".repeat(40)}`),
  ContractA: contracts.ContractA.withAddress(`0x${"7".repeat(40)}`),
  ContractB: contracts.ContractB.withAddress(`0x${"8".repeat(40)}`),
  ContractC: contracts.ContractC.withAddress(`0x${"9".repeat(40)}`),
  ExternalLibrary: contracts.ExternalLibrary.withAddress(`0x${"a".repeat(40)}`),
  InternalLibrary: contracts.InternalLibrary.withAddress(`0x${"b".repeat(40)}`),
  // LibraryUser: contracts.LibraryUser.withAddress(`0x${"c".repeat(40)}`), // TODO: fix invalid bytecode error
