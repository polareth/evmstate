...
export const CONTRACTS = {
  ...
  MultiSlot: contracts.MultiSlot.withAddress(`0x${"2".repeat(40)}`),
  StoragePacking: contracts.StoragePacking.withAddress(`0x${"3".repeat(40)}`),
  Arrays: contracts.Arrays.withAddress(`0x${"4".repeat(40)}`),
  Mappings: contracts.Mappings.withAddress(`0x${"5".repeat(40)}`),
