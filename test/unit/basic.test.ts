      ...
      expect(trace[StoragePacking.address].storage).toEqual(
        expectedStorage(LAYOUTS.StoragePacking, {
          smallValue1: {
            ...
            kind: "primitive",
            slots: [getSlotHex(0)],
            trace: { current: 0, next: 42, modified: true },
          },
          smallValue2: {
            label: "smallValue2",
            type: "uint8",
            kind: "primitive",
            slots: [getSlotHex(0)],
            trace: { current: 0, next: 123, modified: true },
            offset: 1,
          },
          flag: {
            label: "flag",
            ...
            kind: "primitive",
            slots: [getSlotHex(0)],
            trace: { current: false, next: true, modified: true },
            offset: 2,
          },
          someAddress: {
            label: "someAddress",
      ...
      expect(trace[StoragePacking.address].storage).toEqual(
        expectedStorage(LAYOUTS.StoragePacking, {
          ...
          mediumValue1: {
            ...
            kind: "primitive",
            slots: [getSlotHex(3)],
            trace: { current: 0, next: 999, modified: true },
          },
          mediumValue2: {
            label: "mediumValue2",
            type: "uint32",
            kind: "primitive",
            slots: [getSlotHex(3)],
            trace: { current: 0, modified: false },
            offset: 2,
          },
          mediumValue3: {
            label: "mediumValue3",
            ...
            kind: "primitive",
            slots: [getSlotHex(3)],
            trace: { current: 0n, modified: false },
            offset: 6,
          },
        }),
      );
      ...
      expect(trace[StoragePacking.address].storage).toEqual(
        expectedStorage(LAYOUTS.StoragePacking, {
          smallValue1: {
            ...
            kind: "primitive",
            slots: [getSlotHex(0)],
            trace: { current: 0, next: 10, modified: true },
          },
          smallValue2: {
            label: "smallValue2",
            type: "uint8",
            kind: "primitive",
            slots: [getSlotHex(0)],
            trace: { current: 0, next: 20, modified: true },
            offset: 1,
          },
          flag: {
            label: "flag",
            ...
            kind: "primitive",
            slots: [getSlotHex(0)],
            trace: { current: false, modified: false },
            offset: 2,
          },
          someAddress: {
            label: "someAddress",
          ...
          mediumValue1: {
            ...
            kind: "primitive",
            slots: [getSlotHex(3)],
            trace: { current: 0, next: 1000, modified: true },
          },
          mediumValue2: {
            label: "mediumValue2",
            type: "uint32",
            kind: "primitive",
            slots: [getSlotHex(3)],
            trace: { current: 0, next: 2000, modified: true },
            offset: 2,
          },
          mediumValue3: {
            label: "mediumValue3",
          ...
          largeValue1: {
            ...
            kind: "primitive",
            slots: [getSlotHex(1)],
            trace: { current: 0n, next: 12345n, modified: true },
          },
        }),
      );
    });
      ...
      expect(trace[StoragePacking.address].storage).toEqual(
        expectedStorage(LAYOUTS.StoragePacking, {
          largeValue1: {
            ...
            kind: "primitive",
            slots: [getSlotHex(1)],
            trace: { current: 0n, next: 123456789012345678901234567890n, modified: true },
          },
        }),
      );
    });
      ...
      expect(trace[StoragePacking.address].storage).toEqual(
        expectedStorage(LAYOUTS.StoragePacking, {
          smallValue1: {
            ...
            kind: "primitive",
            slots: [getSlotHex(0)],
            trace: { current: 0, next: 1, modified: true },
          },
          smallValue2: {
            label: "smallValue2",
            type: "uint8",
            kind: "primitive",
            slots: [getSlotHex(0)],
            trace: { current: 0, next: 2, modified: true },
            offset: 1,
          },
          flag: {
            label: "flag",
